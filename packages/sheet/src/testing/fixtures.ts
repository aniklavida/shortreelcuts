 ...
 * point. `@shortreelcuts/plan`'s own fixture lives behind that package's
 * private `testing/` folder and isn't part of its published exports, so
 * this package keeps its own, the same way `@shortreelcuts/render` does.
 */
